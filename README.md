...
This is a framework, tools, libs that enables my demo. Think workflow automation for ingesting content like [vellum.ai](vellum.ai) and you will get a picture. See [demo](https://github.com/itissid/drop_webdemo) based on these tools. It has

...
them into our database and check them manually. We only want moods that have a good "diversity" score. Here is a summary from your BFF, where we should start:
...
2. The hardest part is to drive  direction of the team using data and metrics. Since we have less idea of what should happen next: Like should we pilot with text and should we add images/d to the ranking process?